...
To build a VM machine from this repo's source, see the [Azure instructions](docs/create-image-and-azure-resources.md) or the [AWS instructions](docs/create-image-and-aws-resources.md).
